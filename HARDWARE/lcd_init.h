...
#define LCD_SCLK_Clr() GPIO_ResetBits(GPIOA,GPIO_Pin_3)//SCL=SCLK
#define LCD_SCLK_Set() GPIO_SetBits(GPIOA,GPIO_Pin_3)
...
#define LCD_BLK_Clr()  GPIO_ResetBits(GPIOB,GPIO_Pin_11)//BLK
#define LCD_BLK_Set()  GPIO_SetBits(GPIOB,GPIO_Pin_11)
